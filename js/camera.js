...
function startLiveRecording() {
    ...
    function drawLiveFrame() {
        if (video && video.videoWidth > 0 && video.videoHeight > 0) {
            ...
            if (typeof currentFilter !== 'undefined' && filters[currentFilter] && filters[currentFilter].canvasFilter) {
                liveRecCtx.filter = filters[currentFilter].canvasFilter;
            } else {
                liveRecCtx.filter = 'none';
            }
...
async function tangkapFotoDanLiveVideo() {
    ...
    if (typeof currentFilter !== 'undefined' && filters[currentFilter] && filters[currentFilter].canvasFilter) {
        tCtx.filter = filters[currentFilter].canvasFilter;
    } else {
        tCtx.filter = 'none';
    }
    ...
    // Reset filter for future draws just in case
    tCtx.filter = 'none';
